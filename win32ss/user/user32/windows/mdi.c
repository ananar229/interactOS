...
typedef struct
{
    ...
    HBITMAP   hBmpClose; /* InteractOS modification */
} MDICLIENTINFO;
...
#ifdef __REACTOS__
	PostMessageA( hwnd, WM_MDICALCCHILDSCROLL, 0, 0 ); //// InteractOS: Post not send!
#else
...
void WINAPI CalcChildScroll( HWND hwnd, INT scroll )
{
    ...
    *
    * Apparently (in InteractOS at least) the rcClient returned by GetWindowInfo
