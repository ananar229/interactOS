    ...
    _Inout_ PUNICODE_STRING OemHalFileName)
{
    ...
    if (rc != ERROR_SUCCESS)
    {
        ...
        RtlAppendUnicodeToString(AnsiFileName, L"c_1252.nls"); // HACK: InteractOS bug CORE-6105
    }
    else
    {
    ...
    if (rc != ERROR_SUCCESS)
    {
        ...
        RtlAppendUnicodeToString(OemFileName, L"c_437.nls"); // HACK: InteractOS bug CORE-6105
    }
    else
    {
