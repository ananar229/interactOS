 ...
 * RegisterConsoleVDM API of InteractOS/Windows.
 */
                           ...
                           IN HANDLE PaletteHandle)
{
     ...
     * just like Windows' one), but it should success on InteractOS
     * (so that we get console palette changes even for text-mode
     * screen buffers, which is a new feature on InteractOS).
     */
