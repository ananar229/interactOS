...
static /* InteractOS Change: GCC "multiple definition" */
...
#define CdFreeIoContext(IO)     CdFreePool( (PVOID) &(IO) ) /* InteractOS Change: GCC "passing argument 1 from incompatible pointer type" */
...
//
/* InteractOS Change: GCC "passing argument 1 of CdFreePool from incompatible pointer type" */
