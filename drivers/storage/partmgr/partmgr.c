...
/* The Partition Manager Driver in InteractOS complements disk.sys/classpnp.sys drivers
 ...
 * exist in InteractOS. Thus handles some IOCTL_VOLUME_*, and IOCTL_MOUNTMGR_* IOCTLs.
 */
